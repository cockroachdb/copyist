...
# using copyist playback. Note that the drivertest and drivertest/pqtestold test
# packages have to be run separately because they have their own go.mod files
# (see comments in those files for reasons why).
#
