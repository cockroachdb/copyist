...
// Source is a convience alias for io.ReadWriteCloser.
type Source = io.ReadWriteCloser
...
func OpenNamed(t testingT, pathName, recordingName string) io.Closer {
	...
	return OpenSource(t, &lazyFile{PathName: pathName}, recordingName)
}

// OpenNamed is a variant of Open which accepts a caller-specified source and
