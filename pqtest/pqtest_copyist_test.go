...
func init() {
	...
	r21 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{int64(1), `foo`, copyist.ParseTime(`2000-01-01T10:00:00Z`), copyist.ParseTime(`2000-01-01T10:00:00+00:00`), true, copyist.ParseBase64(`QUJDRA`), 1.100000000000000089, copyist.ParseBase64(`MTAwLjEyMzQ`), copyist.ParseBase64(`ezEuMSwyLjJ9`), copyist.ParseBase64(`OGI3ODk3OGItN2Q4Yi00ODllLThjYTktYWM0YmRjNDk1YTgy`)}, nil}}
	r22 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{int64(2), ``, copyist.ParseTime(`2000-02-02T19:11:11Z`), copyist.ParseTime(`2000-02-02T11:11:11+00:00`), false, copyist.ParseBase64(``), -10000000000, copyist.ParseBase64(`MC4w`), copyist.ParseBase64(`e30`), copyist.ParseBase64(`MDAwMDAwMDAtMDAwMC0wMDAwLTAwMDAtMDAwMDAwMDAwMDAw`)}, nil}}
	...
	r28 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{`161f84ee1521155c0000000000000001`}, nil}}
	r29 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{`161f84ee1b196c0c0000000000000001`}, nil}}
