...
func init() {
	...
	r31 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{`162186ed06a9c2b40000000000000001`}, nil}}
	r32 := &copyist.Record{copyist.RowsNext, copyist.RecordArgs{[]driver.Value{`162186ed0fea17480000000000000001`}, nil}}
